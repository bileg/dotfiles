...
defbindings("WScreen", {
    ...
    --(BB)
    kpress(MOD1.."Shift+E", "ioncore.shutdown()"),
    kpress(MOD1.."Shift+R", "ioncore.restart()"),   -- i3=Alt+Shift+R
...
defbindings("WClientWin", {
    ...
    --(BB)
    bdoc("Kill client owning the client window."),
    --kpress(MOD1.."Shift+Q", "WClientWin.kill(_)"),        -- constantly got Xorg error msgs
    kpress(MOD1.."Shift+Q", "WRegion.rqclose_propagate(_, _sub)"),
})
...
defbindings("WGroupCW", {
    ...
    --(BB) alt+enter darahaar full-screen
...
defbindings("WMPlex.toplevel", {
    ...
    --(BB)    http://www.haskell.org/haskellwiki/Xmonad/Using_xmonad_in_Gnome
    --kpress(MOD4.."L", "notioncore.exec_on(_, 'xautolock')"),
    --kpress(MOD4.."L", "notioncore.exec_on(_, 'gnome-screensaver-command -l')"),
    kpress(MOD4.."L", "notioncore.exec_on(_, 'xautolock -locknow')"),
    --kpress(MOD4.."L", "notioncore.exec_on(_, 'i3lock')"),

    bdoc("Query for manual page to be displayed."),
    --kpress(ALTMETA.."F1", "mod_query.query_man(_, ':man')"),
    --(BB)
    kpress(MOD1.."F1", "mod_query.query_man(_, ':man')"),

    bdoc("Show the Notion manual page."),
    --kpress(META.."F1", "ioncore.exec_on(_, ':man notion')"),
    --(BB)
    kpress(MOD1.."F1", "ioncore.exec_on(_, ':man notion')"),

    bdoc("Run a terminal emulator."),
    --kpress(ALTMETA.."F2", "mod_query.exec_on_merr(_, XTERM or 'xterm')"),
    --(BB) alt+enter -> launches a xterm
    kpress(MOD1.."Return", "mod_query.exec_on_merr(_, XTERM or 'xterm')"), 
    
    bdoc("Query for command line to execute."),
    --kpress(ALTMETA.."F3", "mod_query.query_exec(_)"),
    --(BB)
    kpress(MOD1.."D", "mod_query.query_exec(_)"),
