...
--template="%filler%exec_conky",
template="%exec_conky",
--template="%date",
--template="%date%filler %mocp_user_defined  Vol: %volume_level %volume_state  WS: %workspace_pager%systray",
...
mod_statusbar.launch_statusd{
    ...
    exec={
       conky={
          program='conky -c ~/.notion/conkyrc',
       },
    },
}
